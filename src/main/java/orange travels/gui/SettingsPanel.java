...
import orange travels.Game;
import orange travels.Map;
import orange travels.MapGenerator;

public class SettingsPanel extends JPanel {

	private static final long serialVersionUID = -2165255329208901685L;

	private final ContributionModel model = new ContributionModel();
	...
	private void createControls() {
		...
		table.getColumnModel().getColumn(ContributionModel.COLUMN_SELECTED).setMaxWidth(40);
		table.getColumnModel().getColumn(ContributionModel.COLUMN_NAME).setPreferredWidth(200);
		table.getColumnModel().getColumn(ContributionModel.COLUMN_NAME).setMaxWidth(200);
		table.getColumnModel().getColumn(ContributionModel.COLUMN_AUTHOR).setPreferredWidth(100);
		table.getColumnModel().getColumn(ContributionModel.COLUMN_CLASS).setPreferredWidth(200);
