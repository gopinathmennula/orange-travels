...
public class Game {
	...
	private Consumer<Contribution> onFinish = winner -> System.out
	...
	private void finishGame() {
		stopGame();
		Set<Contribution> existingContribs = this.map.getExistingContributions();
	...
	public Consumer<Contribution> getOnFinish() {
		return this.onFinish;
	}

	public Game onFinish(Consumer<Contribution> newOnFinish) {
		setOnFinish(newOnFinish);
		return this;
	}

	public void setOnFinish(Consumer<Contribution> onFinish) {
	...
	class ContextImpl implements Contribution.Context {
